...
ПутьКФайлуПользовательскихНастроек = ОбъединитьПути(КаталогПрограммы(), ПолучитьЗначениеСистемнойНастройки("lib.system"),"opm","src");
ИмяФайлаНастроек = "opm.cfg";
НастройкиПриложения.УстановитьФайлНастроек(ОбъединитьПути(ПутьКФайлуПользовательскихНастроек,ИмяФайлаНастроек));
