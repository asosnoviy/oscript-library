...
Процедура ДобавитьКомандуConfig(Знач Парсер)
	...
	//Парсер.ДобавитьИменованныйПараметрКоманды(Команда, "-useproxy");
	Парсер.ДобавитьПозиционныйПараметрКоманды(Команда, "-useosauth");
	Парсер.ДобавитьИменованныйПараметрКоманды(Команда, "-s", "Сервер");
	Парсер.ДобавитьИменованныйПараметрКоманды(Команда, "-p", "Порт");
	Парсер.ДобавитьИменованныйПараметрКоманды(Команда, "-proxy-user", "Пользователь");
	Парсер.ДобавитьИменованныйПараметрКоманды(Команда, "-proxy-pas", "Пароль");
	Парсер.ДобавитьКоманду(Команда);
КонецПроцедуры
...
Процедура УстановитьПараметры(Знач ЗначенияПараметров)
	Сообщить(ЗначенияПараметров);
КонецПроцедуры	
/////////////////////////////////////////////////////////////////////
