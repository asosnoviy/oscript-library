...
Процедура ДобавитьКомандуConfig(Знач Парсер)
	...
	Парсер.ДобавитьПозиционныйПараметрКоманды(Команда, "-usedefault","использовать ПроксиПоУмолчанию (системные настройки)");
	Парсер.ДобавитьИменованныйПараметрКоманды(Команда, "-s", "Сервер");
	Парсер.ДобавитьИменованныйПараметрКоманды(Команда, "-p", "Порт");
	Парсер.ДобавитьИменованныйПараметрКоманды(Команда, "-user", "Пользователь");
	Парсер.ДобавитьИменованныйПараметрКоманды(Команда, "-pass", "Пароль");
	Парсер.ДобавитьКоманду(Команда);
КонецПроцедуры
